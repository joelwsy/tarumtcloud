        ...
        <div class="row">
            ...
            <div class="col-sm-6 py-5">
                ...
                <div class="d-flex">
                    ...
                    <a href="#" class="px-2 font-rale font-size-14">1,203 ratings | 30+ answered questions</a>
                </div>
                <hr class="m-0">
...
<!--                    </tr>-->
                ...
                <div id="policy">
                    <div class="d-flex">
                        ...
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">Certified <br>Fresh</a>
                        </div>
                    </div>
                </div>
                <!--    !policy -->
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    <small>Delivery by 7 days</small>
                </div>
                <!-- !order-details -->
